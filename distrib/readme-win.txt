Brief Instructions for Setting Up your PC to Type Arabic Text


A. "ArabQWERTYkeyboardWinLnx.pdf" is a compact one-page keyboard 
...
older version of ArabQWERTY is listed among the installed programs, 
...
(including Thai)". 
    ...
    8. Press "Add" button.
    9. Select Input Language: "Arabic", and Keyboard layout/IME : 
"Arab QWERTY6.1".
...
If an older version of ArabQWERTY is listed among the installed 
...
option.
    ...
    5. Press "Add" button.
    6. Select Input Language: "Arabic", and Keyboard: "Arab QWERTY6.1".
...
some time. A confirmation dialog should immediately follow.
 ...
 -> “add a language”
    ...
    7. Select Arabic, click “add”
    8. In new Arabic option, click “options”
    9. Click “add input method” and select “Arab QWERTY6.1”
   10. Save.
...
some time. A confirmation dialog should immediately follow.
    ...
    6. Check that "Arabic" and "Arab QWERTY6.1" are mentiond there. 
    There should be an "Option" link next to it.
    7. Click on the "Option" link. 
    8. Check again that Arab QWERTY (with the proper version) is 
listed there.
...
For miscellaneous hints about using this keyboard, visit
